...
Array4d::Array4d()
:m_dimensions(Array4dDimensions(0,0,0,0,0)), m_NX(0), m_NY(0), m_NZ(0), m_NQ(0),
m_data(nullptr)
{
    //empty
}
...
:m_dimensions(dimensions), m_NX(dimensions.NX), m_NY(dimensions.NY), m_NZ(dimensions.NZ), m_NQ(dimensions.nq)
{ 
    allocate(); 
    set_zero(); 
}
    
Array4d::Array4d(const size_t nx, const size_t ny, const size_t nz, const size_t nq, const size_t nbarriers)
...
void Array4d::allocate(){
    
    m_data = new double[m_NX*m_NY*m_NZ*m_NQ] ;
