...
void CDN::ddf_dxdx(const Array4d& f, Array4d& df){ generic_fd_x(f, df, m_ddf_coeffs, m_dx*m_dx); }
void CDN::ddf_dydy(const Array4d& f, Array4d& df){ generic_fd_y(f, df, m_ddf_coeffs, m_dy*m_dy); }
void CDN::ddf_dzdz(const Array4d& f, Array4d& df){ generic_fd_z(f, df, m_ddf_coeffs, m_dz*m_dz); }
