...
void Communicator::communicate_x_direction(Array4d& arr) const{
    ...
    MPI_Sendrecv(&arr(nx, 0, 0, 0), 1, slice, dest, 0,
                &arr(0, 0, 0, 0), 1, slice, source, 0,
                m_cartesian_comm, 
                MPI_STATUS_IGNORE);
    ...
    MPI_Cart_shift(m_cartesian_comm, 2, -1, &source, &dest);
    MPI_Sendrecv(&arr(ngc, 0, 0, 0), 1, slice, dest, 0,
                &arr(ngc + nx, 0, 0, 0), 1, slice, source, 0,
                m_cartesian_comm, 
                MPI_STATUS_IGNORE);
...
void Communicator::communicate_y_direction(Array4d& arr) const{
    ...
    MPI_Sendrecv(
                &arr(0, ny, 0, 0), 1, slice, dest, 0, //take from south domain indices
                &arr(0, 0, 0, 0), 1, slice, source, 0, //place to north halo indices
                m_cartesian_comm, 
                MPI_STATUS_IGNORE);
    ...
    MPI_Cart_shift(m_cartesian_comm, 1, -1, &source, &dest);
    MPI_Sendrecv(
                &arr(0, ngc, 0, 0), 1, slice, dest, 0, //take from north domain indices
                &arr(0, ngc + ny, 0, 0), 1, slice, source, 0, //place to south halo indices
                m_cartesian_comm, 
                MPI_STATUS_IGNORE);
...
void Communicator::communicate_z_direction(Array4d& arr) const{
    ...
    MPI_Sendrecv(
                &arr(0, 0, nz, 0), 1, slice, dest, 0, //take from front domain indices
                &arr(0, 0, 0, 0), 1, slice, source, 0, //place to back halo indices
                m_cartesian_comm, 
                MPI_STATUS_IGNORE);
    ...
    MPI_Cart_shift(m_cartesian_comm, 0, -1, &source, &dest);
    MPI_Sendrecv(
                &arr(0, 0, ngc, 0), 1, slice, dest, 0, //take from back domain indices
                &arr(0, 0, ngc + nz, 0), 1, slice, source, 0, //place to front halo indices
                m_cartesian_comm, 
                MPI_STATUS_IGNORE);
