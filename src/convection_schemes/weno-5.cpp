...
void Weno5::solve(const Grid&    grid,
...
void Weno5::compute_residual(const Grid&    grid,
                             const Array4d& f_x,
                             const Array4d& f_y,
                             const Array4d& f_z,
                             Array4d&       residual) {
...
void Weno5::x_sweep(
    const Array4d& F, const Array4d& U, const Array4d& W, const Array3d& eig, Array4d& f) {
...
template <typename T>
std::array<T, 3>
Weno5::WENO5_weights_borges(T f_m2, T f_m1, T f_, T f_p1, T f_p2, const double d[3]) {
...
template <typename T> T Weno5::WENO5_right(T fR_m2, T fR_m1, T fR_, T fR_p1, T fR_p2) {
...
template <typename T> T Weno5::WENO5_left(T fL_m2, T fL_m1, T fL_, T fL_p1, T fL_p2) {
