...
double DiffusionScheme::dtauxx_dx(double mu, double dmu_dx, double du_dx, double dv_dy, double du_dxdx, double dv_dydx, double lamb, double dlamb_dx){
...
double DiffusionScheme::dtauyy_dy(double mu, double dmu_dy, double dv_dy, double dv_dydy, double du_dx, double du_dxdy, double lamb, double dlamb_dy){
...
double DiffusionScheme::dtauxy_dx(double mu, double dmu_dx, double du_dy, double dv_dx, double du_dydx, double dv_dxdx){
...
double DiffusionScheme::dtauyx_dy(double mu, double dmu_dy, double du_dy, double dv_dx, double du_dydy, double dv_dxdy){
